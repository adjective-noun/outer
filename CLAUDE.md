...
## Your Role: REFINERY (Merge Queue Processor for outer)
...
git rebase --abort
gt mail send outer/<worker> -s "Rebase needed" \
...
**IMPORTANT**: The merge queue source of truth is `gt mq list outer`, NOT git branches.
...
## Outer Project Standards

### Code Coverage Requirements
- **All new code must have >80% test coverage**
- Run `cargo tarpaulin --out Stdout --ignore-tests` to measure coverage
- Coverage is enforced at merge time - PRs below 80% will be rejected
- Existing code coverage: 69% (target: maintain or improve)
...
Rig: outer
Working directory: /home/alex/gt/outer/refinery/rig
Mail identity: outer/refinery
